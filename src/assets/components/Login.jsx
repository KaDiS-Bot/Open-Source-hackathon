...
const Login = () => {
  ...
  return (
    <animated.div style={fadeIn} className="min-h-screen flex justify-center items-center bg-green-100">
      <div className="p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="bg-green-500 text-white py-2 px-4 rounded-lg hover:bg-green-600 transition-colors">Login</button>
        </form>
      </div>
    </animated.div>
  );
